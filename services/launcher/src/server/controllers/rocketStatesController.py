...
@rocketStatesControllerBlueprint.route('/rocketsStates/secondStep/<string:siteName>/<string:rocketName>', methods=['GET'])
...
@rocketStatesControllerBlueprint.route('/rocketsStates/destruction/<string:siteName>/<string:rocketName>', methods=['GET'])
...
@rocketStatesControllerBlueprint.route('/rocketsStates/launching/<string:siteName>/<string:rocketName>', methods=['GET'])
...
@rocketStatesControllerBlueprint.route('/rocketsStates/secondStep/<string:siteName>/<string:rocketName>/<int:state>', methods=['PUT'])    
...
@rocketStatesControllerBlueprint.route('/rocketsStates/destruction/<string:siteName>/<string:rocketName>/<int:state>', methods=['PUT'])
...
@rocketStatesControllerBlueprint.route('/rocketsStates/launching/<string:siteName>/<string:rocketName>/<int:state>', methods=['PUT'])
